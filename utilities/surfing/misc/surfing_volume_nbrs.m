...
offsets=surfing_inds2subs([3 3 3],(1:27)')-2; % 27x3 matrix with offsets relative to center voxel
offsetsnn=sum(offsets.^2,2); % NN level for offsets
nnnbrs=histc(offsetsnn,1:3); % should be [6, 12, 8]' 

nnmsk=false(1,3); % NN 1,2,3?
